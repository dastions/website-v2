      ...
      <div class="max-w-3xl mx-auto pt-32 pb-12 md:pt-40 md:pb-20">
        ...
        <div class="text-center pb-10">
          ...
          <div class="max-w-3xl mx-auto">
            <p class="text-lg text-gray-700">Need support or have a question about Simple? We're here to help.</p>
          </div>
        </div>

        <!-- Search -->
        <div>
          <button class="w-full bg-white/70 text-gray-400 text-sm inline-flex items-center justify-between pl-4 pr-3 py-3.5 shadow-sm shadow-black/[0.03] rounded-lg relative before:absolute before:inset-0 before:rounded-[inherit] before:border before:border-transparent before:[background:linear-gradient(var(--color-gray-100),var(--color-gray-200))_border-box] before:[mask:linear-gradient(white_0_0)_padding-box,_linear-gradient(white_0_0)] before:[mask-composite:exclude_!important] before:pointer-events-none whitespace-nowrap" aria-controls="quick-find-modal" @click.stop="searchModalOpen = true">
            <div class="flex items-center justify-center">
              <svg class="w-4 h-4 fill-gray-500 mr-3 shrink-0" width="16" height="16" viewBox="0 0 16 16"
            ...
            <div class="ml-3 flex gap-1">
              ...
              <div class="flex items-center justify-center h-6 w-6 bg-white text-gray-400 rounded-sm shadow-xs">
                <svg class="fill-current" xmlns="http://www.w3.org/2000/svg" width="8" height="9" fill="none">
                  <path
                    d="M0 8.727V0h1.581v4.01h.107L5.091 0h1.93L3.649 3.916l3.405 4.811H5.152L2.548 4.986l-.967 1.142v2.6H0Z" />
                </svg>
              </div>
            </div>
          </button>
