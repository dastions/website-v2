    ...
    <main class="grow">
      ...
      <section class="relative">
        ...
        <div class="absolute left-1/2 -translate-x-1/2 -top-32 ml-[580px] pointer-events-none" aria-hidden="true">
          <div class="w-80 h-80 rounded-full bg-linear-to-tr from-blue-500 opacity-50 blur-[160px] will-change-[filter]"></div>
        </div>
        <div class="absolute left-1/2 -translate-x-1/2 top-[420px] ml-[380px] pointer-events-none" aria-hidden="true">
          <div class="w-80 h-80 rounded-full bg-linear-to-tr from-blue-500 to-gray-900 opacity-50 blur-[160px] will-change-[filter]">
          </div>
        </div>
        ...
        <div class="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div class="flex justify-between pt-32 pb-12 md:pt-40 md:pb-20">
            ...
            >
              <div v-show="sidebarNavOpen" class="md:hidden fixed inset-0 z-50 bg-gray-900/20 transition-opacity" aria-hidden="true"></div>
            </Transition>             
            ...
            >
              <aside
                ...
                class="max-md:fixed max-md:left-0 max-md:inset-y-0 max-md:z-50 w-[268px] max-md:h-screen max-md:bg-gray-50 md:border-r [border-image:linear-gradient(to_bottom,var(--color-slate-200),var(--color-slate-300),transparent)1] md:shrink-0 md:opacity-100! md:block!"
              >
                  ...
                  <article class="pb-10 border-b border-gray-200">
                    ...
                    <div class="min-w-0">
                      ...
                      <div class="md:hidden flex items-center mb-8">
                        ...
                        <button
                          ref="hamburger"
                          class="group inline-flex w-8 h-8 bg-white hover:bg-gray-50 shadow-sm rounded-lg text-center items-center justify-center transition"
                  ...
                  <div class="text-center">
                    <div
                      ...
                      <div class="flex gap-2">
                        <button class="btn-sm bg-white hover:bg-gray-50 shadow-sm rounded-sm px-2 py-0">
