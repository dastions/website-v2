...
<template>
  <section
    ...
    <div class="absolute bottom-0 left-1/2 -translate-x-1/2 translate-y-1/2 -z-10" aria-hidden="true">
      <div class="w-80 h-80 rounded-full bg-linear-to-tr from-blue-500 to-gray-900 opacity-30 blur-[160px]">
      </div>
    </div>
    <div class="max-w-6xl mx-auto px-4 sm:px-6">
      <div class="py-12 md:py-20">
        ...
        <!-- Testimonials grid -->
        <div class="grid sm:grid-cols-3 gap-4 md:gap-6 [mask-image:linear-gradient(to_top,--theme(--color-white/.3),black_800px)]">
