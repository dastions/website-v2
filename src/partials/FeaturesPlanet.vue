    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6">
      <div class="py-12 md:py-20">
        ...
        <div class="max-w-3xl mx-auto text-center pb-16 md:pb-20">
          <h2 class="text-3xl md:text-4xl font-bold text-gray-200">Trabajamos con clientes alrededor de
            todo el mundo.</h2>
        </div>
        ...
        <div
          ...
          <article>
            <h3 class="font-medium text-gray-200 flex items-center space-x-2 mb-2">
              ...
              <span>Analíticas instantáneas</span>
            </h3>
            <p class="text-[15px] text-gray-400">Monitorea el rendimiento de tus aplicaciones en tiempo real con
              dashboards claros y métricas que impulsan decisiones rápidas.</p>
          </article>
          <article>
            <h3 class="font-medium text-gray-200 flex items-center space-x-2 mb-2">
              <svg class="fill-blue-500" xmlns="http://www.w3.org/2000/svg" width="16" height="16">
            ...
            <p class="text-[15px] text-gray-400">Optimizamos la estructura de tus proyectos con metadatos bien definidos
              para mejorar la indexación y compatibilidad.</p>
          </article>
          <article>
            <h3 class="font-medium text-gray-200 flex items-center space-x-2 mb-2">
              <svg class="fill-blue-500" xmlns="http://www.w3.org/2000/svg" width="16" height="16">
            ...
            <p class="text-[15px] text-gray-400">Mejoramos la visibilidad de tu sitio y optimizamos la velocidad de
              carga para ofrecer experiencias digitales ágiles y efectivas.</p>
          </article>
          <article>
            <h3 class="font-medium text-gray-200 flex items-center space-x-2 mb-2">
              <svg class="fill-blue-500" xmlns="http://www.w3.org/2000/svg" width="16" height="16">
            ...
            <p class="text-[15px] text-gray-400">Desarrollamos soluciones a medida que se adaptan a las necesidades
              únicas de tu negocio.</p>
          </article>
          <article>
            <h3 class="font-medium text-gray-200 flex items-center space-x-2 mb-2">
              <svg class="fill-blue-500" xmlns="http://www.w3.org/2000/svg" width="16" height="16">
            ...
            <p class="text-[15px] text-gray-400">
              Adaptamos tus aplicaciones para distintos idiomas, zonas horarias y mercados, garantizando que tu software
              funcione de forma óptima en cualquier región.
            </p>
          </article>
          <article>
            <h3 class="font-medium text-gray-200 flex items-center space-x-2 mb-2">
            ...
            <p class="text-[15px] text-gray-400">Definimos URLs canónicas que evitan duplicidades y garantizan una
              correcta indexación de tu contenido en buscadores.</p>
          </article>
        </div>
      </div>
    </div>
